...
const steps = [
  { icon: ScanLineIcon, label: "Analyzing your website" },
...
const LoaderSteps = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
      ...
      <p className='mt-2 text-xs text-gray-400 transition-opacity duration-700 opacity-100'>This may take around 2-3 minutes...</p>
    </div>
  )
}
