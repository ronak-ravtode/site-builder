...
export const rollbackToVersion = async (req: Request<{ projectId: string, versionId: string }>, res: Response) => {
    try {
        const userId = req.userId;
        if (!userId) {
            return res.status(401).json({ message: 'Unauthorized' });
...
// Delete a project
export const deleteProject = async (req: Request<{ projectId: string, versionId: string }>, res: Response) => {
    try {
        const userId = req.userId;
        const { projectId } = req.params;
...
export const getProjectPreview = async (req: Request<{ projectId: string, versionId: string }>, res: Response) => {
    try {
        const userId = req.userId;
        const { projectId } = req.params;
...
export const getPublishedProjects = async (req: Request<{ projectId: string, versionId: string }>, res: Response) => {
    try {
...
export const getProjectById = async (req: Request<{ projectId: string, versionId: string }>, res: Response) => {
    try {
        const { projectId } = req.params;
...
// save project code
export const saveProjectCode = async (req: Request<{ projectId: string, versionId: string }>, res: Response) => {
    try {
        const userId = req.userId;
        const { projectId } = req.params;
        const { code } = req.body;
